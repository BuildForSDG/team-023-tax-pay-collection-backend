...
describe('*********** USERS ***********', () => {
  ...
  describe('/GET users', () => {
    ...
    it('it should GET the users with filters', (done) => {
      chai
        .request(server)
        .get('/users?filter=admin&fields=first_name,email,city,state,country,phone')
        .set('Authorization', `Bearer ${tokens.admin}`)
        .end((err, res) => {
          res.should.have.status(200);
          res.body.should.be.an('object');
  ...
  describe('/POST user', () => {
    it('it should NOT POST a user without first_name', (done) => {
      const user = {};
      chai
        .request(server)
        .post('/users')
    ...
    it('it should POST a user ', (done) => {
      const user = {
        frist_name: faker.random.words(),
        middle_name: faker.random.words(),
      ...
      chai
        ...
        .end((err, res) => {
          ...
          res.body.should.be.a('object');
          res.body.should.include.keys('_id', 'frist_name', 'last_name', 'email', 'verification');
    ...
    it('it should GET a user by the given id', (done) => {
      ...
      chai
        ...
        .end((error, res) => {
          res.should.have.status(200);
          res.body.should.be.a('object');
          res.body.should.have.property('frist_name');
    ...
    it('it should UPDATE a user given the id', (done) => {
      ...
      chai
        ...
        .end((error, res) => {
          ...
          res.body.should.be.a('object');
          res.body.should.have.property('_id').eql(id);
          res.body.should.have.property('frist_name').eql('JS123456');
          res.body.should.have.property('middle_name').eql('JS123456');
          res.body.should.have.property('last_name').eql('JS123456');
          res.body.should.have.property('email').eql('emailthatalreadyexists@email.com');
          createdID.push(res.body._id);
          done();
        });
    });
